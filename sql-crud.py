...
# Create a class-based table for "Programmer" table
...
# creating the database using the delarative_base subclass
...
kulwinder_singh = Programmer(
    first_name="Kulwinder",
    last_name="Singh",
    gender="M",
    nationality="Indian",
    famous_for="Front End Development"
)
